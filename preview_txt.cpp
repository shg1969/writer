...
Preview_txt::Preview_txt(QWidget *parent) : QWidget(parent)
{
    /****************************窗体界面****************************/
    ...
    /****************************信号和槽****************************/
    //按照用户的选择，更改显示的编码方式
    connect(ComboBox_celect_coding,&QComboBox::currentTextChanged,this,&Preview_txt::encoding_Changed);
...
//配置预览对象
void Preview_txt::preview_conf(QString book_name,QByteArray txt)
{
    label_book_name=new QLabel("书名:"+book_name);
    preview_txt=txt;
    browser->setText(QString(preview_txt));
    this->show();
}
void Preview_txt::encoding_Changed(const QString &text)
{
